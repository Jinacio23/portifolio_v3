        ...
        <div id="cv" className={`bg-[#5a5ab2] fixed top-0 bottom-0 left-0 right-0 m-auto flex flex-col p-3 rounded-xl justify-between h-[20vh] w-[80vw] max-w-[650px] shadow-black/40 ${hide}`}>
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                    <a href="/docs/CV_JoseInacio1.pdf" target="_blank" className="bg-[#23232e] text-xs p-2 px-5 rounded-lg">Apenas vizualizar</a>
                    <a href="/docs/CV_JoseInacio1.pdf" className="bg-[#23232e] text-xs p-2 px-5 rounded-lg" download>Sim</a>
                </div>
            </div>
        </div>
    )
